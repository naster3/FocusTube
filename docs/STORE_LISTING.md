...
- Whitelist for URLs or domains
- Quick blocks for popular sites
- Focus timer (Pomodoro)
- Dashboard with metrics and exports
...
- `notifications`: Alert when focus/break timer completes.
- `alarms`: Schedule focus/break timer transitions.
- `permissions`: Request optional host permissions when the user adds domains.
